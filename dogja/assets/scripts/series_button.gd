...
func set_button(series_folder,button_position,i):
	...
	#var img_path = "res://media/manhwa/" + series_folder[i] + "/icon.webp"
	var img_path = "C:/Dogja/media/manhwa/" + series_folder[i] + "/icon.webp"
	var img = Image.new()
	img.load(img_path)
	if img != null:
...
func _on_pressed():
	Global.series_path = "C:/Dogja/media/manhwa/" + series_name
